...
const breadcrumbItems = ref([{ label: 'Electronics' }, { label: 'Computer' }, { label: 'Notebook' }, { label: 'Accessories' }, { label: 'Backpacks' }, { label: 'Item' }]);
...
<template>
    <div class="grid p-fluid">
        ...
        <div class="col-12">
            <div class="card card-w-title flex flex-wrap">
                <div class="col-12 md:col-8 h-full">
                    ...
                    <h5>Steps</h5>
                    <Steps :model="nestedRouteItems" :readonly="false" class="mt-5" />
                </div>
        ...
        <div class="col-12 md:col-4">
            ...
            <div class="card card-w-title" @contextmenu="onContextRightClick">
                <h5>ContextMenu</h5>
