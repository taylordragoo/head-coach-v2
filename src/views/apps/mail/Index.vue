...
<template>
    ...
    <Dialog v-model:visible="dialogVisible" header="New Message" modal styleClass="mx-3 sm:mx-0 sm:w-full md:w-8 lg:w-6" contentStyleClass="border-round-bottom border-top-1 surface-border p-0">
        <Reply :mail-detail="mailDetail" @save="onSaveReplyMail"></Reply>
    </Dialog>
</template>
