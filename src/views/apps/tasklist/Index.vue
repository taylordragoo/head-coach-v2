...
<template>
    <div class="card">
        <div class="flex justify-content-between align-items-center mb-5">
            ...
            <Button class="p-button-outlined font-semibold" icon="pi pi-plus" label="Create Task" @click="openCreateDialog()"></Button>
        </div>
    ...
    <Dialog :header="dialogConfig.header || ''" v-model:visible="dialogConfig.visible" modal class="mx-3 sm:mx-0 sm:w-full md:w-8 lg:w-6" contentClass="border-round-bottom border-top-1 surface-border p-0">
        <create-task-dialog :selected-task="selectedTask" @close="onCloseDialog()" @save="onSaveDialog"></create-task-dialog>
    </Dialog>
</template>
