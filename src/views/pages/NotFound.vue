...
<template>
    ...
    <div class="px-5 min-h-screen flex justify-content-center align-items-center bg-cover bg-center" :style="{ backgroundImage: `url('/demo/images/notfound/bg-404.jpg') ` }">
        <div class="z-1 text-center">
            <div class="text-900 font-bold text-white text-8xl mb-4">NOT FOUND</div>
            <p class="line-height-3 text-white mt-0 mb-5 text-700 text-xl font-medium">Requested resource is not available.</p>
            <router-link to="/">
                <button type="button" class="p-button p-button-primary font-medium p-button-raised">Go to Dashboard</button>
            </router-link>
        </div>
    </div>
</template>
