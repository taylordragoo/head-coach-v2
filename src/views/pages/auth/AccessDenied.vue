...
<template>
    <svg width="54px" height="54px" viewBox="0 0 74 64" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="flex absolute z-1 mx-6 my-6">
        <title>Shape</title>
    ...
    <div class="px-5 min-h-screen flex justify-content-center align-items-center bg-cover bg-center" :style="{ backgroundImage: `url('/demo/images/auth/bg-access.jpg')` }">
        <div class="relative text-center">
            <div class="text-900 font-bold text-white text-8xl mb-4">ACCESS DENIED</div>
            <p class="line-height-3 text-white mt-0 mb-5 text-700 text-xl font-medium">You do not have the necessary permissions.</p>
            <Button class="p-button-warning font-medium p-button-raised" @click="navigateToDashboard"> Go to Dashboard </Button>
        </div>
    </div>
    <AppConfig simple />
</template>
