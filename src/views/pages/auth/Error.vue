...
<template>
    ...
    <div
        class="px-5 min-h-screen flex justify-content-center align-items-center bg-cover bg-center"
        :style="{
            backgroundImage: `url('/demo/images/auth/bg-error.jpg') `,
        }"
    >
        <div class="z-1 text-center">
            <div class="text-900 font-bold text-white text-8xl mb-4">ERROR</div>
            <p class="line-height-3 text-white mt-0 mb-5 text-700 text-xl font-medium">Something went wrong!</p>
            <Button class="p-button-danger font-medium" @click="navigateToDashboard"> Go to Dashboard </Button>
        </div>
    </div>
    <AppConfig simple />
</template>
