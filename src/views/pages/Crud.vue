...
const statuses = ref([{ value: 'INSTOCK' }, { value: 'LOWSTOCK' }, { value: 'OUTOFSTOCK' }]);
            ...
            <div class="card">
                ...
                <Dialog v-model:visible="productDialog" :style="{ width: '450px' }" header="Product Details" :modal="true" class="p-fluid">
                    ...
                    <div class="field">
                        ...
                        <Dropdown id="inventoryStatus" v-model="product.inventoryStatus" :options="statuses" placeholder="Select a Status">
