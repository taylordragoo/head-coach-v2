...
<template>
    <div class="surface-section px-4 py-8 md:px-6 lg:px-8 border-1 surface-border border-round">
        ...
        <div class="flex flex-column sm:flex-row sm:align-items-center sm:justify-content-between py-5">
            ...
            <div>
                <Button label="Details" icon="pi pi-list" class="p-button-outlined p-button-primary mr-2"></Button>
                <Button label="Print" icon="pi pi-print" class="p-button-outlined p-button-primary"></Button>
            </div>
        </div>
    ...
    <div class="surface-section px-4 py-8 md:px-6 lg:px-8 border-1 surface-border border-round mt-6">
